...
signals:
	/**
		Emitted when the edge of a widget is changed, allowing listeners to adjust accordingly, such
		as relayout their widgets.
		This signal is emitted as soon as the edge change, even during a drag
		operation.
	*/
	void edgeChanged(ScreenEdge, ScreenEdge);
