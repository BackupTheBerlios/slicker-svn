...
public:
  ...
  virtual ~EdgeWidgetManager();
	...
	/**
		Get the single running instance of EdgeWidgetManager
	*/
	static EdgeWidgetManager *instance();
...
signals:
	...
	*/
	void widgetUnregistered(EdgeWidget *widget);

private:
	void registerWidget(EdgeWidget *widget);
	void unregisterWidget(EdgeWidget *widget);
...
private:
	static EdgeWidgetManager *_instance;
